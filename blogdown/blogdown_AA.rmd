...
- `active = true`: keep section; `active = false`: discard section
...
- [Cheat sheet](https://highlightjs.org/static/demo/)

- edit `config/_default/params.toml`

- activate `highlight = true` and write down your style `highlight_style = " "`

<center><img src="images/highlight.png" style="width: 90%" /></center>
...
- relative path will have prefix with your domain name (e.g., annielyu.com), e.g.,
...
- DO NOT leave out prefix `https://` when referring to external webpages.

--

- Recommended practice for specifying permanent links of your post in `config.toml`
...
- Publish your repository to [GitHub](https://github.com/)
  ...
  + can ignore the `public` folder in `.gitignore`

- [Netlify](https://www.netlify.com/) $\rightarrow$ New site from Git
