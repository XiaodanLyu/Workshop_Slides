...
- content: <span style="color:blue">mostly markdown files</span>
  ...
  + authors/admin -- biography
  
  + post, talk, project, publication -- achievements `r emo::ji("100")`  
...
<center><img src="images/publication_markdown.png" style="width: 80%" /></center>

## Add publication citation

- use **bibtex** format. This can be done using BibDesk

<center><img src="images/bibtex.png" style="width: 90%" /></center>
